module.exports = (client) => {
  ...
  client.deposit = async (user, amount) => {
    await client.currency.subtract(`${user}.wallet`, amount);
    await client.currency.add(`${user}.bank`, amount)
  }

  client.withdraw = async (user, amount) => {
    await client.currency.subtract(`${user}.bank`, amount)
    await client.currency.add(`${user}.wallet`, amount)
  }
}